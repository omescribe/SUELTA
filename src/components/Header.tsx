...
export const Header: React.FC<HeaderProps> = ({ onOpenGuide, theme, onToggleTheme }) => {
  return (
    <header className="px-5 sm:px-6 py-3.5 sm:py-4 flex items-center justify-between border-b border-white/5 dark:border-white/5 bg-[#121212]/85 dark:bg-[#121212]/85 backdrop-blur-md sticky top-0 z-40">
      {/* Brand & Logo */}
      ...
      <div className="flex items-center gap-2">
        {/* Relaxing Background Music Toggle (30% default volume) */}
