...
import dolorImg from '../assets/images/8_Dolor-malestar.png';
...
export const IllustrationAbrumado: React.FC<IllustrationProps> = ({ className = 'w-16 h-16' }) => (
  <img
    src={abrumadoImg}
    alt="Abrumado"
    className={`${className} object-contain rounded-lg bg-[#141210]`}
  />
);
...
// 9. DOLOR O MALESTAR (Dolor físico)
export const IllustrationDolor: React.FC<IllustrationProps> = ({ className = 'w-16 h-16' }) => (
  <img
    src={dolorImg}
    alt="Dolor o malestar"
    className={`${className} object-contain rounded-lg bg-[#141210]`}
  />
);

// 10. EJERCICIO COMPLETADO
export const IllustrationCompletado: React.FC<IllustrationProps> = ({ className = 'w-48 h-48' }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <circle cx="100" cy="100" r="72" fill="#FF6B4A" opacity="0.28" />
    <g stroke="#FF6B4A" strokeWidth="1.5" strokeLinecap="round" opacity="0.6">
    ...
    <path d="M10 180C40 150 70 160 100 170C130 160 160 150 190 180H10Z" fill="#1c1917" opacity="0.9" />
    <path d="M72 100C68 76 82 62 100 62C118 62 132 76 128 100C124 116 120 128 120 128H80C80 128 76 116 72 100Z" fill="#2c2522" />
    <path d="M68 150C68 132 80 122 100 122C120 122 132 132 132 150L138 200H62L68 150Z" fill="#a8391a" />
    <rect x="94" y="116" width="12" height="12" rx="4" fill="#D8AD8E" stroke="#141210" strokeWidth="1.5" />
    <ellipse cx="100" cy="98" rx="22" ry="24" fill="#D8AD8E" stroke="#141210" strokeWidth="1.5" />
    <path d="M74 88C80 72 92 68 100 68C108 68 120 72 126 88C118 80 110 78 100 80C90 78 82 80 74 88Z" fill="#38302B" />
    <path d="M88 98C91 102 96 102 98 98" stroke="#141210" strokeWidth="2.4" strokeLinecap="round" />
    <path d="M112 98C109 102 104 102 102 98" stroke="#141210" strokeWidth="2.4" strokeLinecap="round" />
    <path d="M94 110C97 113 103 113 106 110" stroke="#141210" strokeWidth="2.2" strokeLinecap="round" />
    <ellipse cx="94" cy="138" rx="10" ry="7" fill="#D8AD8E" stroke="#141210" strokeWidth="1.3" transform="rotate(-15 94 138)" />
    <ellipse cx="106" cy="138" rx="10" ry="7" fill="#D8AD8E" stroke="#141210" strokeWidth="1.3" transform="rotate(15 106 138)" />
  </svg>
);
